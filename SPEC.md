...
The full 559-root map is in `lexicon.tsv`, one line per root, with its derivation.
...
4. **Vocabulary depth.** 559 roots plus derivation covers ordinary life. Medicine, law
